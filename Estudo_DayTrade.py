...
def extrai_dados(ticker, period="1mo"):
...
# Agentes de IA 
agente_web_search = Agent(name="Agente de Busca Web",
...
agente_financeiro = Agent(name="Agente Analise Financeira",
                              model=Groq(id="deepseek-r1-distill-llama-70b"),
...
st.set_page_config(page_title="Agente de IA", page_icon=":100:", layout="wide")
...
# Título principal
st.title(":100: Análise de Tickets Financeiros Internacionais")
